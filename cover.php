      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="inner cover">
            <div class="center">
              <h1 class="cover-heading">Realizing your Dreams</h1>
              <p class="lead" id="lbody">This is your first application help you Making and realizing your Dream</p>
            </div>
            <div class="center">
              <h1 class="cover-heading">Most Good Dreamers have Good plans.</h1>
              <p class="lead" id="lbody2">Designing your jobs. and executing your plans and ...</p>
            </div>
            <div class="center">
              <h1 class="cover-heading">Create notices and sharing another cooperators</h1>
              <p class="lead" id="lbody3">Brainstorming and analyzing your visions. and more people helps you plans more things</p>
            </div>
