...
function mk_edit_string(id, title, subtitle, body, block, button_type, table_idx, modified_type) // table_idx는 form 호출시 넘겨줄 값
{
    var edit_view_string="";
    ...
    if(button_type=="save_close"){ // 실상, 2버튼형, VIEW로 가정
        ...
        edit_view_string="edit_view_"+id;
    }
    //idx_string="modal_view_"+id;
    //console.log(edit_view_string);
    var ret=
            '<div class="edit_title">'
                '<h3>'+title+'</h3>'+
                '<span id="table_view_idx" class="in_info">'+table_idx+'</span>'+
                '<span id="edit_view_name" class="in_info">'+edit_view_string+'</span>'+
            '<div class="edit_body">'+
                '<h5>'+subtitle+'</h5>'+
                '<p>'+body+'</p>'+
            '</div>'+
                        ...
                        case "modify_delete":
                           // console.log(modify_func("'+id+'_Modal" , "modify_'+id+'"));
                            if(modified_type==='modal'){
                                ...
                                ret+='<button type="button" class="btn btn-warning add_or_modify">Modify</button>'+
                                    '<button type="button" class="btn btn-danger" id="button_delete">Delete</button>'+
                                    '<button type="submit" class="btn btn-primary">Save changes</button>'+
                                    '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>';                                
                            }
    ...
    if(button_type==="modify_delete"){
        ...
        else{ // modifyed_type==='grid'
        //    ret+=mk_edit_form_string()...;
        }
...
function mk_edit_form_string(id, title, body_title, place_value, button_type, table_idx)
{   
