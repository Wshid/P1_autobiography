<html>
    ...
    <body>
        ...
        <script type="text/javascript">
            alert("RUN");
            function load_by_js(name){
                //alert(name);
                console.log(load_function); // 값이 null로 변하지가 않았음 // 함수 포인팅을 못하는 상태
                load_function(name); // load_function is Not a function! 왜지..
            }
